...
class AppTheme {
  static const Color cBg = Color(0xFF0A0B14);
  static const Color cSurface = Color(0xFF121422);
  static const Color cEdge = Color(0xFF1D2036);
  static const Color cAccent = Color(0xFF818CF8);
  static const Color cAccent2 = Color(0xFFC7D2FE);
